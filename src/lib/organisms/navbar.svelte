...
<nav class="sidebar close">
    <header>
        <div class="image-text">
            <span class="image">
                <a href="/Log-in">
                    <img src="https://avatars.githubusercontent.com/u/74552944?v=4" alt="Gebruiker-foto" aria-label="Gebruiker-foto">
                </a>
            </span>
    ...
    <div class="menu-bar">
        <div class="menu">
            <ul>
                <li class="search-box">
                    <i class='bx bx-search icon' aria-hidden="true"></i>
            ...
            <ul class="menu-links">
                ...
                <li class="nav-link">
                    <a href="/">
                        <i class='bx bx-list-ul icon' aria-hidden="true"></i>
                ...
                <li class="nav-link">
                    <a href="/Uitleengeschiedenis">
                        <i class='bx bx-bell icon' aria-hidden="true"></i>
                        <span class="text nav-text">Uitleengeschiedenis</span>
                    </a>
                </li>
                <li class="nav-link">
                    <a href="/Betalingen">
                        <i class='bx bx-pie-chart-alt icon' aria-hidden="true"></i>
                        <span class="text nav-text">Betalingen</span>
                    </a>
                </li>
                <li class="nav-link">
                    <a href="/">
        ...
        <div class="bottom-content">
            <ul>
                ...
                <li class="mode">
                    <div class="sun-moon" aria-label="Toggle Dark/Light Mode">
